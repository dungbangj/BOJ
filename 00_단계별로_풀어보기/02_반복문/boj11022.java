...
public class boj11022 {
	...
	private static final Logger logger = Logger.getLogger(boj11022.class.getName());
	...
	private static String getMultiTable(List<int[]> inputs) {
		...
		int i = 1;
		for (int[] AB : inputs) {
			sb.append("Case #").append(i++).append(": ").append(AB[0]).append(" + ").append(AB[1]).append(" = ").append(AB[0] + AB[1]).append("\n");
		}
		return sb.toString();
	}
}