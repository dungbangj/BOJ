...
public class boj15894 {
	...
	private static final Logger logger = Logger.getLogger(boj15894.class.getName());
	...
	private static String getResult(int inputData) {
		BigInteger result = new BigInteger(String.valueOf(inputData));
		return new BigInteger("4").multiply(result).toString();
	}
